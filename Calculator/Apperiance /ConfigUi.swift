...
class ConfigUi: UIView {
    ...
    public func label(numberOfLines: Int = 0, isHidden: Bool = false, alpha: CGFloat = 1,
                    backgroundColor: UIColor = .clear, colors: [CGFloat] = [197.0, 163.0, 154.0], size: CGFloat = 28,
                    primaryAlpha: CGFloat = 1.0, textAlignment: NSTextAlignment = .right, cornerRadius: CGFloat = 0,
                      heightConstant: CGFloat = 40.0) -> UILabel {
